...
| [docs/](docs/) | The applied method set: RISK_MANAGEMENT, HARM_RISK (+ §9 [report stub](docs/HARM_RISK_REPORT.md)), SECURITY_RISK, SOUP, TRACEABILITY, CONFORMANCE_TRANSFER, [standards/](docs/standards/) (CONFORMANCE index, GSPR checklist, 62304 coverage map) |
